  ...
  const categoryColumns = [
    ...
    },
    {
      ...
      render: (_: any, record: Category) => (
        <div className='flex'>
        <Button type="primary" className='bg-black mr-2' onClick={() => handleEditCountry(record)}>
          Edit
        </Button>
  ...
  const subcategoryColumns = [
    ...
    },
    {
      ...
      render: (_: any, record:SubCategory) => (
        <div className='flex'>
        <Button type="primary" className='bg-black mr-2' onClick={() => handleEditSubCategory(record)}>
          Edit
        </Button>
